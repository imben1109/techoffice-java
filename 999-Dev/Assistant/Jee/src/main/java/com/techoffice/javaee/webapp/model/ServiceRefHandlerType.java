...
public class ServiceRefHandlerType {
    ...
    protected com.techoffice.javaee.webapp.model.String handlerName;
    ...
    protected List<com.techoffice.javaee.webapp.model.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<com.techoffice.javaee.webapp.model.String> portName;
     ...
     *     
     */
    public com.techoffice.javaee.webapp.model.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(com.techoffice.javaee.webapp.model.String value) {
     ...
     * 
     */
    public List<com.techoffice.javaee.webapp.model.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<com.techoffice.javaee.webapp.model.String>();
        }
     ...
     * 
     */
    public List<com.techoffice.javaee.webapp.model.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<com.techoffice.javaee.webapp.model.String>();
        }
