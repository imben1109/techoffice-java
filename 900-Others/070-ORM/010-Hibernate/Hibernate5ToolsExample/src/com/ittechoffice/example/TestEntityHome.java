 ...
 * @see com.ittechoffice.example.TestEntity
...
public class TestEntityHome {
	...
	public List findByExample(TestEntity instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.ittechoffice.example.TestEntity")
